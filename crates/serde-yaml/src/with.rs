...
pub mod singleton_map {
    ...
    V: Visitor<'de>,
  {
    ...
    where
      E: de::Error,
    {
      self.delegate.visit_enum(de::value::StringDeserializer::new(v))
    }
...
pub mod singleton_map_recursive {
    ...
    D: Serialize,
  {
      ...
      S: Serializer,
    {
      self
        .delegate
        .serialize(SingletonMapRecursive { delegate: serializer })
    }
  }
    ...
    D: Serializer,
  {
    ...
    type SerializeStructVariant = SerializeStructVariantAsSingletonMapRecursive<D::SerializeMap>;
    ...
    D: Deserializer<'de>,
  {
    ...
    where
      V: Visitor<'de>,
    {
      self.delegate.deserialize_option(SingletonMapRecursiveAsEnum {
        name: "",
        delegate: visitor,
      })
    }
