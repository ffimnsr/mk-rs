...
pub mod consts {
  ...
  static MINUS_PLUS_SEP: Lazy<LineSeparator> = Lazy::new(|| LineSeparator::new('-', '+', '+', '+'));
  /// A line separator made of `=` and `+`
  static EQU_PLUS_SEP: Lazy<LineSeparator> = Lazy::new(|| LineSeparator::new('=', '+', '+', '+'));
  ...
  /// +----+----+
  /// ```
  pub static FORMAT_DEFAULT: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .column_separator('|')
      .borders('|')
  ...
  /// +----+----+
  /// ```
  pub static FORMAT_NO_TITLE: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .column_separator('|')
      .borders('|')
      .separator(LinePosition::Intern, *MINUS_PLUS_SEP)
  ...
  /// +----+----+
  /// ```
  pub static FORMAT_NO_LINESEP_WITH_TITLE: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .column_separator('|')
      .borders('|')
      .separator(LinePosition::Title, *MINUS_PLUS_SEP)
  ...
  /// +----+----+
  /// ```
  pub static FORMAT_NO_LINESEP: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .column_separator('|')
      .borders('|')
      .separator(LinePosition::Bottom, *MINUS_PLUS_SEP)
  ...
  /// --------
  /// ```
  pub static FORMAT_NO_COLSEP: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .separator(LinePosition::Intern, *MINUS_PLUS_SEP)
      .separator(LinePosition::Title, *EQU_PLUS_SEP)
      .separator(LinePosition::Bottom, *MINUS_PLUS_SEP)
  ...
  ///  d   c
  /// ```
  pub static FORMAT_CLEAN: Lazy<TableFormat> = Lazy::new(|| FormatBuilder::new().padding(1, 1).build());
  ...
  /// +--------+
  /// ```
  pub static FORMAT_BORDERS_ONLY: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .padding(1, 1)
      .separator(LinePosition::Title, *EQU_PLUS_SEP)
      .separator(LinePosition::Bottom, *MINUS_PLUS_SEP)
  ...
  ///  c  | d
  /// ```
  pub static FORMAT_NO_BORDER: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .padding(1, 1)
      .separator(LinePosition::Intern, *MINUS_PLUS_SEP)
      .separator(LinePosition::Title, *EQU_PLUS_SEP)
  ...
  ///  c  | d
  /// ```
  pub static FORMAT_NO_BORDER_LINE_SEPARATOR: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .padding(1, 1)
      .separator(LinePosition::Title, *MINUS_PLUS_SEP)
      .column_separator('|')
  ...
  /// └────┴────┴────┘
  /// ```
  pub static FORMAT_BOX_CHARS: Lazy<TableFormat> = Lazy::new(|| {
    FormatBuilder::new()
      .column_separator('│')
      .borders('│')
